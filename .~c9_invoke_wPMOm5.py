...
def add_recipes():
    ...
    return render_template("addrecipe.html", recipe_category=recipe_category, difficulty =difficulty, main_ingredient=main_ingredient)
...
def edit_recipe(recipe_id):
    ...
    return render_template('editrecipe.html', recipe=recipe, recipe_category=category_list, difficulty =difficulty_list )
